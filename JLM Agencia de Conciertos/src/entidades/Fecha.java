...
public class Fecha {
    ...
    public static java.util.Date dameFecha() {

        java.util.Date fechaDate = new Date();//En esta variable se pasara el String
        boolean fallo = false;

        do {
            try {
                //Hay que decir que en caso de no introducir las / dara error y el prgrama cascara,sin embargo en caso de introducir las 3/ y estas estar incomploetas como 2/1/200 el programa volvera a pedir la fecha
